package com.youwiz.polling.service;

import com.youwiz.polling.exception.BadRequestException;
import com.youwiz.polling.exception.ResourceNotFoundException;
import com.youwiz.polling.model.*;
...
import com.youwiz.polling.util.ModelMapper;
...
//        Sort sort = new Sort(Sort.Direction.DESC, "createdAt");
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        Vote userVote = null;
        if (currentUser != null) {
            userVote = voteRepository.findByUserIdAndRollId(currentUser.getId(), pollId);
        }
    ...
    private Map<Long, User> getPollCreatorMap(List<Poll> content) {
        List<Long> creatorIds = content.stream()
